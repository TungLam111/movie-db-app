...
part of 'media_movie_image_model.dart';
...
MediaMovieImageModel _$MediaMovieImageModelFromJson(
...
Map<String, dynamic> _$MediaMovieImageModelToJson(
        MediaMovieImageModel instance) =>
    <String, dynamic>{
      'id': instance.id,
